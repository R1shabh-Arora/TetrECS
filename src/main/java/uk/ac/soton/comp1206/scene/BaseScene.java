...
public abstract class BaseScene {
    ...
    /**
     * The main window on which the game is being played
     */
    protected final GameWindow gameWindow;

    /**
     * The main Pane on which is responsible for displaying UI on the scene
     */
    protected GamePane root;

    /**
     * Initialising the scene in the field
     */
